...
int main()
{
    int nQuantity = 0, nLength = 0, nFirstTime, nFinishTime;
    cin>> nQuantity >> nLength;
    nFirstTime = nLength;
    nFinishTime = 0;
    for (int i = 0; i < nQuantity; i++)
    {
        int nPosition = 0;
        cin>> nPosition;
        int nTime = (i%2==0?nLength - nPosition:nPosition);
        if(nTime<nFirstTime)
        {
            nFirstTime = nTime;
        }
        else{}
        if(nTime > nFinishTime)
        {
            nFinishTime = nTime;
        }
        else{}
    }
    cout<< nFirstTime << ' ' << nFinishTime;
}